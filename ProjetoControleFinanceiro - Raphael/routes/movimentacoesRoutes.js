...
//h) Gráfico
router.get('/getDadosGraficoTipoPagamento/:id', movimentacoesController.getDadosGraficoTipoPagamento);
//i) Gráfico tipo de movimentação
router.get('/getDadosGraficoTipoMovimentacao/:id', movimentacoesController.getDadosGraficoTipoMovimentacao);
